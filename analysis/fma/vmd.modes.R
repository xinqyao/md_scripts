...
vmd.modes <- function(modes, mode=NULL, pdb=NULL, file=NULL, mag=5, 
                      ...
                      ref.0 = NULL, ref.1 = NULL, ## reference min/max (linear) or mean/sd (scaled) values to make color scale consistent
